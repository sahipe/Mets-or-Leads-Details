...
const MetsOrLeadsDetailsExcelDownload = () => {
  ...
  const handleDownload = async () => {
    try {
      ...
      link.href = url;
      link.setAttribute("download", "Mets_or_Leads_details_data.xlsx");
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded-2xl shadow-lg border border-gray-200">
      <h3 className="text-lg font-semibold mb-4 text-gray-800">
        Download Mets or Leads details
      </h3>
...
export default MetsOrLeadsDetailsExcelDownload;
